...
if __name__ == "__main__":
    ...
    parser.add_argument('--download_only', action='store_true', help='Only download files without extracting')
    parser.add_argument('--extract_only', action='store_true', help='Only extract previously downloaded files')
